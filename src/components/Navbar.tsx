        ...
        <div className="flex justify-between items-center h-full">
          ...
          >
            <div className="bg-lime w-11 h-11 md:w-16 md:h-16 flex items-center justify-center neo-border rounded-xl md:rounded-3xl overflow-hidden transition-all group-hover:shadow-neo-sm group-hover:-rotate-3 shrink-0">
              {!imgError ? (
                ...
                <Camera className="w-7 h-7 md:w-10 md:h-10 text-black" aria-hidden="true" />
              )}
            </div>
          ...
          <div className="md:hidden flex items-center gap-3">
            ...
            <Sheet>
              ...
              <SheetContent side="right" className="w-full sm:w-[400px] border-l-3 border-black p-0 bg-background outline-none shadow-neo-sm">
                  ...
                  <div className="flex items-center justify-between">
                    <div className="flex items-center gap-3">
                      <div className="bg-white w-10 h-10 flex items-center justify-center neo-border rounded-xl shadow-neo-sm">
                        <Camera className="w-6 h-6 text-coral" aria-hidden="true" />
                      </div>
                    ...
                    <SheetClose asChild>
                      <Button aria-label="Tutup Menu" variant="ghost" size="icon" className="neo-border bg-white rounded-xl h-10 w-10 shadow-neo-sm active:scale-90 hover:bg-coral hover:text-white transition-all">
                        <X className="h-6 w-6" />
                      </Button>
                    </SheetClose>
                  </div>
                ...
                <div className="flex flex-col p-8 h-[calc(100vh-100px)] relative overflow-hidden">
                  ...
                  <div className="mt-auto pb-10 relative z-10">
                    <div className="p-6 bg-white neo-border rounded-3xl shadow-neo-sm">
