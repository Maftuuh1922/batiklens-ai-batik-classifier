      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 text-center md:text-left">
          <div className="md:col-span-2 space-y-6">
            ...
            <div className="flex gap-4 justify-center md:justify-start">
              {[
                { Icon: Instagram, label: "Follow Instagram Kami" },
                { Icon: Github, label: "Repositori Github" },
                { Icon: Globe, label: "Kunjungi Website Resmi" }
              ].map(({ Icon, label }, i) => (
                <a key={i} href="#" aria-label={label} className="p-3 bg-white/5 neo-border rounded-xl hover:bg-coral hover:text-white transition-all shadow-neo-sm active:scale-90">
          ...
          <div className="space-y-6">
            ...
            <div className="flex flex-col gap-4 font-bold text-lg md:text-xl uppercase tracking-tighter">
              <a href="#home" className="hover:text-coral transition-all hover:translate-x-2">Beranda</a>
        ...
        <div className="flex flex-col md:flex-row justify-between items-center gap-8 text-center md:text-left">
          <p className="text-sm font-bold text-gray-500 uppercase tracking-widest">
            © 2025 BatikLens Team. Crafted with <Heart className="inline w-4 h-4 text-coral fill-coral mx-1 animate-pulse" aria-hidden="true" /> for Indonesia.
          </p>
